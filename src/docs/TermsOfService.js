...
const TermsOfService = (props) => {
  ...
  return(
    <div className='terms_wrapper'>
      ...
      You agree that by accessing this_project, you have read, understood, and agreed to be bound by all of these Terms of Use.
      </p>
      <p>
      Supplemental terms and conditions or documents that may be posted on this_project from time to time are hereby expressly incorporated herein by reference. 
      ...
      the changes in any revised Terms of Use by your continued use of this_project after the date such revised Terms of Use are posted.
      </p>
      <p>
      The information provided on this_project is not intended for distribution to or use by any person or entity in any jurisdiction or country where such distribution 
      ...
      Accordingly, those persons who choose to access this_project from other locations do so on their own initiative and are solely responsible for compliance with local laws, 
      if and to the extent local laws are applicable.
      </p>
      <p>
      this_project is intended for users who are at least 13 years of age. 
      ...
      and be directly supervised by, their parent or guardian to use this_project. 
      If you are a minor, you must have your parent or guardian read and agree to these Terms of Use prior to you using this_project.
      </p>
      <p>
      ...
      databases, functionality, software, website designs, audio, video, text, photographs, and graphics on this_project 
      (collectively, the “Content”) and the trademarks, service marks, and logos contained therein (the “Marks”) are owned or controlled by us or licensed to this_project, 
      ...
      The Content and the Marks are provided on this_project “AS IS” for your information and personal use only. 
      Except as expressly provided in these Terms of Use, no part of this_project 
      ...
      <p>
      Provided that you are eligible to use this_project, 
      you are granted a limited license to access and use this_project and to download or 
      ...
      By using this_project, you represent and warrant that:
        <ul>
          ...
          <li>5.  you are not a minor in the jurisdiction in which you reside, or if a minor, you have received parental permission to use this_project;</li>
          <li>6.  you will not access this_project through automated or non-human means, whether through a bot, script, or otherwise;</li>
          <li>7.  you will not use this_project for any illegal or unauthorized purpose; and (8) your use of this_project will not violate any applicable law or regulation.</li>
        </ul>
      </p>
      <p>
      ...
      this_project may not be used in connection with any commercial endeavors except those that are specifically endorsed or approved by us.
      </p>
      <p>
      As a user of this_project, you agree not to:
        <ul>
          <li>1.  Systematically retrieve data or other content from this_project to create or compile, directly or indirectly, a collection, compilation, database, or directory without written permission from us.</li>
          <li>2.  Make any unauthorized use of this_project, including collecting usernames and/or email addresses of users by electronic or other means for the purpose of sending unsolicited email, or creating user accounts by automated means or under false pretenses.</li>
          <li>3.  Use a buying agent or purchasing agent to make purchases on this_project.</li>
          <li>4.  Use this_project to advertise or offer to sell goods and services.</li>
          <li>5.  Circumvent, disable, or otherwise interfere with security-related features of this_project, including features that prevent or restrict the use or copying of any Content or enforce limitations on the use of this_project and/or the Content contained therein.</li>
          <li>6.  Engage in unauthorized framing of or linking to this_project.</li>
          ...
          <li>10.  Interfere with, disrupt, or create an undue burden on this_project or the networks or services connected to this_project.</li>
          ...
          <li>13.  Use any information obtained from this_project in order to harass, abuse, or harm another person.</li>
          <li>14.  Use this_project as part of any effort to compete with us or otherwise use this_project and/or the Content for any revenue-generating endeavor or commercial enterprise.</li>
          <li>15.  Decipher, decompile, disassemble, or reverse engineer any of the software comprising or in any way making up a part of this_project.</li>
          <li>16.  Attempt to bypass any measures of this_project designed to prevent or restrict access to this_project, or any portion of this_project.</li>
          <li>17.  Harass, annoy, intimidate, or threaten any of our employees or agents engaged in providing any portion of this_project to you.</li>
          <li>18.  Delete the copyright or other proprietary rights notice from any Content.</li>
          <li>19.  Copy or adapt this_project’s software, including but not limited to Flash, PHP, HTML, JavaScript, or other code.</li>
          <li>20.  Upload or transmit (or attempt to upload or to transmit) viruses, Trojan horses, or other material, including excessive use of capital letters and spamming (continuous posting of repetitive text), that interferes with any party’s uninterrupted use and enjoyment of this_project or modifies, impairs, disrupts, alters, or interferes with the use, features, functions, operation, or maintenance of this_project.</li>
          ...
          <li>22.  Except as may be the result of standard search engine or Internet browser usage, use, launch, develop, or distribute any automated system, including without limitation, any spider, robot, cheat utility, scraper, or offline reader that accesses this_project, or using or launching any unauthorized script or other software.</li>
          <li>23.  Disparage, tarnish, or otherwise harm, in our opinion, us and/or this_project.</li>
          <li>24.  Use this_project in a manner inconsistent with any applicable laws or regulations.</li>
        </ul>
      </p>
      <p>
      As a user of this_project, you agree to:
        <ul>
      ...
      When you create or make available any Contributions, you thereby represent and warrant that:
        <ul>
          ...
          <li>2.  You are the creator and owner of or have the necessary licenses, rights, consents, releases, and permissions to use and to authorize us, this_project, and other users of this_project to use your Contributions in any manner contemplated by this_project and these Terms of Use.</li>
          <li>3.  You have the written consent, release, and/or permission of each and every identifiable individual person in your Contributions to use the name or likeness of each and every such identifiable individual person to enable inclusion and use of your Contributions in any manner contemplated by this_project and these Terms of Use.</li>
      ...
      We are not liable for any statements or representations in your Contributions provided by you in any area on this_project. 
      You are solely responsible for your Contributions to this_project 
      ...
      We have the right, in our sole and absolute discretion:
        <ul>
          ...
          <li>2.  to re-categorize any Contributions to place them in more appropriate locations on this_project.</li>
      ...
      (1) providing your Third-Party Account login information through this_project; 
      ...
      so that it is available on and through this_project via your account, including without limitation any friend lists 
      ...
      personally identifiable information that you post to your Third-Party Accounts may be available on and through your account on this_project. 
      ...
      then Social Network Content may no longer be available on and through this_project. 
      You will have the ability to disable the connection between your account on this_project and your Third-Party Accounts at any time. 
      </p>
      <p>
      ...
      and informing you of those contacts who have also registered to use this_project. 
      You can deactivate the connection between this_project and your Third-Party Account by contacting us using the contact information below 
      ...
      If you decide to leave this_project and access the Third-Party Websites 
      ...
      of any website to which you navigate from this_project 
      or relating to any applications you use or install from this_project. 
      ...
      If you are an advertiser, you shall take full responsibility for any advertisements you place on this_project 
      and any services provided on this_project or products sold through those advertisements. 
      Further, as an advertiser, you warrant and represent that you possess all rights 
      and authority to place advertisements on this_project, including, but not limited to, 
      ...
      We reserve the right, but not the obligation, to: 
        <ul>
          <li>1.  monitor this_project for violations of these Terms of Use. </li>
          ...
          <li>4.  in our sole discretion and without limitation, notice, or liability, to remove from this_project or otherwise disable all files and content that are excessive in size or are in any way burdensome to our systems. </li>
      ...
      <p>
      By using this_project, you agree to be bound by our Privacy Policy posted on this_project, 
      which is incorporated into these Terms of Use. 
      Please be advised this_project is hosted in the United States. 
      If you access this_project from the European Union, Asia, 
      ...
      then through your continued use of this_project, you are transferring your data to the United States, 
      ...
      <p>
      If you believe that any material available on or through this_project infringes upon any copyright you own or control, 
      ...
      <p>
      WITHOUT LIMITING ANY OTHER PROVISION OF THESE TERMS OF USE, WE RESERVE THE RIGHT TO, IN OUR SOLE DISCRETION AND WITHOUT NOTICE OR LIABILITY, DENY ACCESS TO AND USE OF this_project 
      ...
      WE MAY TERMINATE YOUR USE OR PARTICIPATION IN this_project OR DELETE YOUR ACCOUNT AND ANY CONTENT OR INFORMATION THAT YOU POSTED AT ANY TIME, WITHOUT WARNING, IN OUR SOLE DISCRETION.
      </p>
      <p>
      ...
      We also reserve the right to modify or discontinue all or part of this_project without notice at any time. 
      We will not be liable to you or any third party for any modification, price change, suspension, or discontinuance of this_project.  
      </p>
      <p>
      We cannot guarantee this_project will be available at all times. 
      We may experience hardware, software, or other problems or need to perform maintenance related to this_project, 
      resulting in interruptions, delays, or errors. 
      We reserve the right to change, revise, update, suspend, discontinue, or otherwise modify this_project at any time or for any reason without notice to you. 
      ...
      <p>
      In no event shall any Dispute brought by either Party related in any way to this_project be commenced more than one (1) years after the cause of action arose. 
      ...
      or update the information on this_project at any time, without prior notice.
      </p>

      <h2>DISCLAIMER</h2>
      <p>
      this_project IS PROVIDED ON AN AS-IS AND AS-AVAILABLE BASIS. 
      YOU AGREE THAT YOUR USE OF this_project AND OUR SERVICES WILL BE AT YOUR SOLE RISK. 
      TO THE FULLEST EXTENT PERMITTED BY LAW, WE DISCLAIM ALL WARRANTIES, EXPRESS OR IMPLIED, IN CONNECTION WITH this_project 
      ...
      AND NON-INFRINGEMENT. WE MAKE NO WARRANTIES OR REPRESENTATIONS ABOUT THE ACCURACY OR COMPLETENESS OF this_project’S CONTENT 
      OR THE CONTENT OF ANY WEBSITES LINKED TO this_project AND WE WILL ASSUME NO LIABILITY OR RESPONSIBILITY FOR ANY 
      (1) ERRORS, MISTAKES, OR INACCURACIES OF CONTENT AND MATERIALS, 
      (2) PERSONAL INJURY OR PROPERTY DAMAGE, OF ANY NATURE WHATSOEVER, RESULTING FROM YOUR ACCESS TO AND USE OF this_project, 
      (3) ANY UNAUTHORIZED ACCESS TO OR USE OF OUR SECURE SERVERS AND/OR ANY AND ALL PERSONAL INFORMATION AND/OR FINANCIAL INFORMATION STORED THEREIN, 
      (4) ANY INTERRUPTION OR CESSATION OF TRANSMISSION TO OR FROM this_project, 
      (5) ANY BUGS, VIRUSES, TROJAN HORSES, OR THE LIKE WHICH MAY BE TRANSMITTED TO OR THROUGH this_project BY ANY THIRD PARTY, AND/OR 
      ...
      CONTENT POSTED, TRANSMITTED, OR OTHERWISE MADE AVAILABLE VIA this_project. 
      WE DO NOT WARRANT, ENDORSE, GUARANTEE, OR ASSUME RESPONSIBILITY FOR ANY PRODUCT OR SERVICE ADVERTISED OR OFFERED BY A THIRD PARTY THROUGH this_project, ANY HYPERLINKED WEBSITE, 
      ...
      OR OTHER DAMAGES ARISING FROM YOUR USE OF this_project, 
      ...
      (6) any overt harmful act toward any other user of this_project with whom you connected via this_project. 
      ...
      as well as data relating to your use of this_project. 
      Although we perform regular routine backups of data, you are solely responsible for all data that you transmit 
      or that relates to any activity you have undertaken using this_project. 
      ...
      and other communications we provide to you electronically, via email and on this_project, satisfy any legal requirement that such communication be in writing. 
      </p>
      <p>
      YOU HEREBY AGREE TO THE USE OF ELECTRONIC SIGNATURES, CONTRACTS, ORDERS, AND OTHER RECORDS, 
      AND TO ELECTRONIC DELIVERY OF NOTICES, POLICIES, AND RECORDS OF TRANSACTIONS INITIATED OR COMPLETED BY US OR VIA this_project. 
      </p>
      <p>
      ...
      in respect to this_project constitute the entire agreement and understanding between you and us. 
      ...
      and us as a result of these Terms of Use or use of this_project. 
