...
const Privacy = (props) => {
  ...
  return(
    <div className='terms_wrapper'>
      ...
      <p>
      Thank you for choosing to be part of our community at this_project (“Company”, “we”, “us”, or “our”).
      </p>
      <p>
      ...
      <p>
      We automatically collect certain information when you visit, use or navigate this_project. 
      ...
      This information is primarily needed to maintain the security and operation of this_project, and for our internal analytics and reporting purposes.
      </p>
      <p>
      ...
      We may allow selected third parties to use tracking technology on this_project, which will enable them to collect data about how you interact with this_project over time. 
      ...
      <p>
      We may use third-party advertising companies to serve ads when you visit this_project. 
      ...
      <h3>Other Users</h3>
      <p>
      When you share personal information or otherwise interact with public areas of this_project, such personal information may be viewed by all users 
      ...
      that are otherwise made clear to you on this_project. Please note that we do not control, and are not responsible for, 
      ...
      <p>
      this_project may contain advertisements from third parties that are not affiliated with us 
      ...
      and policies of any third parties, including other websites, services or applications that may be linked to or from this_project. 
      ...
      By using this_project, you represent that you are at least 18 or that you are the parent or 
      guardian of such a minor and consent to such minor dependent’s use of this_project. 
      ...
      If you become aware of any data we have collected from children under age 18, please contact us at totally_real_email_address@this_project.com.
      </p>
      ...
      have a registered account with this_project, you have the right to request removal of unwanted data that you publicly post on this_project. 
      ...
      We will make sure the data is not publicly displayed on this_project, 
